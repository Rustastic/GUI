...
impl Legend {
    ...
    pub fn render(&self, ui: &mut egui::Ui) {
        let circles = [
            ...
            (LEGEND_X_START + 65.0, COMMUNICATION_SERVER_COLOR, "CommunicationServer"),
            (LEGEND_X_START + 220.0, TEXT_CONTENT_SERVER_COLOR, "TextContentServer"),
            (LEGEND_X_START + 352.5, MEDIA_CONTENT_SERVER_COLOR, "MediaContentServer"),
